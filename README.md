...
Keep records of all users appeared in events. When a new event coming in, update the information in related users. 

#### User level (user.py):
In each user, keep records of his/her last T purchase
